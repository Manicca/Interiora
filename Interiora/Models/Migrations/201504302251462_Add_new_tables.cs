    ...
    public partial class Add_new_tables : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.WorkspaceDb", t => t.WorkspaceId, cascadeDelete: true)
        ...
        {
            DropForeignKey("dbo.FurnitureLocations", "WorkspaceId", "dbo.WorkspaceDb");
