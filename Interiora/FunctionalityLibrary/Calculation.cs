...
namespace FunctionalityLibrary
{
    public class Calculation
    {
        public static class Distance
        {
            ...
            public static void CalculateBonders(ref Point start, ref Point end, PictureBox pictureBox1, List<Figure> AllFigures)
            {
                ...
                if (AllFigures != null)
                {
                    var rooms = AllFigures.Where((r) => r is RoomFigure);

                    foreach (var r in rooms)
                        Calculation.Distance.CalculateAheadPoints(r, ref start, ref end);
                }
            }
